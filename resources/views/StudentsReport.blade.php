...
@section('content')
    ...
    <section class="container">
        <div class="page-header text-center mt-5">
            ...
            <h2 id="Report_Heading">Participated Students </h2>
            <hr>
        </div>
        <div class="row">
            <div class="col-3">
        ...
        <script type='text/javascript'>
            ...
            $(document).ready(function(){
                ...
                var academic_year = $('#academic_year').val();
                // Empty the tbody
                $('#student_report_sheet').find('tr').remove();
                // AJAX request
                $.ajax({
                    url: 'getParticipatedStudents',
                    type: 'get',
                        ...
                        if(len > 0){
                            ...
                            for(var i=0; i<len; i++){
                                ...
                                var row = "<tr><td>"
                                    ...
                                    +project_title+
                                    "</td></tr>";
                                $("#student_report_sheet").append(row);
