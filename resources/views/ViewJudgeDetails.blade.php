...
@section('content')
        ...
        <section class="container">
            <div class="page-header text-center mt-5">
                ...
                <h2 id="Report_Heading">Judge Report</h2>
                <hr>
            </div>
            <div class="row">
                <div class="col-10">
            ...
            <br>
            @php
                $users = DB::table('judges')->select('*')->get();
            @endphp 
            ...
            <table class="table table-striped text-center" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->jcompany }}</td>
                        <td>{{ $user->jexp }}</td>
                        <td>{{ $user->jpassword }}</td>
                        <td  id="removelinks">
                            <a class="btn btn-info btn-sm" href="edit_judge_details/{{ $user->id }}">Edit</a>
                            &nbsp;&nbsp;
                            <a class="btn btn-danger btn-sm" href="remove_judge/{{ $user->id }}" onclick="return askNredirect()">Remove</a>
                        </td>
                    </tr>
