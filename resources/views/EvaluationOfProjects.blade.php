                            ...
                            <form action="judge_marks_submit" method="post" autocomplete="off" class="row g-3 needs-validation" style="font-size: 14px;">
                                ...
                                <div class="row col-12">
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="text" readonly class="form-control" id="academic_year" name="academic_year" value="{{$infodata->academic_year}}" required>
                                    </div>

                                    <div class="col-md-4 mt-4">
                                        <label for="department" class="form-label">Department</label>
                                        <input type="text" readonly class="form-control" id="department" name="department" value="{{$infodata->department}}" required>
                                    </div>

                                    <div class="col-md-4 mt-4">
                                        <label for="project_id" class="form-label">Project ID</label>
                                        <input type="text" readonly class="form-control" id="project_id" name="project_id" value="{{$infodata->project_id}}" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="text" readonly class="form-control" id="ucid" name="ucid" value="{{$infodata->ucid}}" required>
                                    </div>

                                    <div class="col-md-8 mt-4">
                                        <label for="name" class="form-label">Student Name</label>
                                        <input type="text" readonly class="form-control" id="name" name="name" value="{{$infodata->name}}" required>
                                    </div>
