...
@section('content')
                            ...
                            <form action="judge_marks_submit" method="post" autocomplete="off" class="row g-3 needs-validation" style="font-size: 14px;">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="text" readonly class="form-control" id="department" name="department"  required>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-4">                                            
                                        ...
                                        <textarea readonly class="form-control" id="project_title" name="project_title" required></textarea>
                                    </div>
                                                   ...
                                                   // Read data and create <option >
                                                        for(var i=0; i<len; i++){
                                                            ...
                                                            "<tr>"+
                                                                ...
                                                                "<td><input type='number' readonly class='form-control' style='width:80px;' id='r_total["+i+"]' value='"+{{$proData[0]->total}}+"' name='r_total[]'></td>"+
                                                            "</tr>"+
                                                        "</tbody>"+
                                                    "</table>"+
                                                "</div>"+
        ...
        @php
                $cnt=DB::table('students')->select('group_count')->where('project_id',$proData[0]->project_id)->get(); 
