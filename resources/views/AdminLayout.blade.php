                ...
                <div id="mega-menu-wrap-primary" class="mega-menu-wrap">
                    ...
                    <ul id="mega-menu-primary" class="mega-menu max-mega-menu mega-menu-horizontal mega-no-js" data-event="hover_intent" data-effect="fade_up" data-effect-speed="200" data-effect-mobile="disabled" data-effect-speed-mobile="0" data-mobile-force-width="false" data-second-click="go" data-document-click="collapse" data-vertical-behaviour="standard" data-breakpoint="600" data-unbind="true" data-hover-intent-timeout="300" data-hover-intent-interval="100">
                        <li class='mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-align-bottom-left mega-menu-flyout mega-menu-item-25693' id='mega-menu-item-25693'>
                            <a class="mega-menu-link" href="admin_home_page" tabindex="0">Home</a>
                        </li>
                        <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-menu-item-9759" id="mega-menu-item-9759">
                            ...
                            <ul class="mega-sub-menu">
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-10363" id="mega-menu-item-10363">
                                    <a class="mega-menu-link" href="edit_announcement">Edit Announcement</a>
                                </li>
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="add_mentor">Add Mentor</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="add_other_user">Add User</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="add_judge">Add Judge</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="project_allotment_page">Allocate the projects</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="declare_result">Declare Result</a>
                                </li>
                        ...
                        <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-menu-item-9759" id="mega-menu-item-9759">
                            ...
                            <ul class="mega-sub-menu">
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-10363" id="mega-menu-item-10363">
                                    <a class="mega-menu-link" href="mentor_report">Mentor Report</a>
                                </li>
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="judge_report">Judge Report</a>
                                </li>
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="others_report">Other Users Report</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="getStudentsreport">Student Reports</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="ProjectsReport">Projects Reports</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="project_stat_report">Statistical Reports</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="WinnerReportPage">Winner Reports</a>
                                </li>

                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="evaluation_sheet">Evaluation Sheet</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-has-children mega-align-bottom-left mega-menu-flyout mega-menu-item-9759" id="mega-menu-item-9759">
                            ...
                            <ul class="mega-sub-menu">
                                ...
                                <li class="mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-menu-item-9761" id="mega-menu-item-9761">
                                    <a class="mega-menu-link" href="admin_logout">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
