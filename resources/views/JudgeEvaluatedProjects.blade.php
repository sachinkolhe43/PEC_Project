...
@section('content')
    ...
    <section class="container">
        <div class="page-header text-center mt-5">
            ...
            <h2 id="Report_Heading">My Evaluated Projects</h2>
            <hr>
        </div>
        <div class="row">
            <div class="col-3">
        ...
        <script type='text/javascript'>
            ...
            $(document).ready(function(){
                ...
                // Empty the tbody
                $('#student_evalve_sheet').find('tr').remove();

                // AJAX request
                $.ajax({
                    url: 'projectevaluationreport',
                    type: 'get',
                    data:{ayear:academic_year,jemail:jemail},
                    dataType: 'json',
                    success: function(response){
                        ...
                        if(len > 0){
                            ...
                            for(var i=0; i<len; i++){
                                ...
                                var project_id = response['data'][i].project_id;
                                var project_title = response['data'][i].project_title;
                                var marks = response['data'][i].project_marks;
                                ...
                                var row = "<tr><td>"
                                    ...
                                    +marks+
                                    "</td></tr>";
                                $("#student_evalve_sheet").append(row);
